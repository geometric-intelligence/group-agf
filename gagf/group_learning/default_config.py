...
powers = {
    ...
    "dihedral": [0.0, 600.0,  0.0, 50.0, 100.0, 400.0],
...
fourier_coef_diag_values = {
    ...
    "dihedral": [
        np.sqrt(24*p / dim**2) for p, dim in zip(powers["dihedral"], [1, 1, 2, 2, 1, 1])
    ],
    "octahedral": [
...
# Training parameters
epochs = [5000]  # , 20000, 30000] #, 10000] #, 10000, 20000, 30000], 50000 for cn x cn
